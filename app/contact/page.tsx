...
import {
    MapPin, Mail, ArrowRight, ShieldCheck, PhoneCall, Headphones
} from "lucide-react";
...
export default function ContactPage() {
    ...
    // Same planner state the homepage uses — the contact page renders the very
    // same TripPlanner component so both forms stay identical by construction.
    ...
    // There is no tour grid on this page, so "Browse tours" goes to /plans.
            ...
            <section className="pb-16 md:pb-24">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                        ...
                        <div className="lg:col-span-5 space-y-6">
                            <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden">
                                <div className="bg-gradient-to-r from-royal-800 to-royal-900 px-5 sm:px-7 py-4 flex items-center gap-3 text-white">
                                    ...
                                    <div>
                                        <h2 className="font-display text-xl font-semibold">Immediate Help</h2>
                        ...
                        {/* Form Column — the identical planner form used on the homepage */}
                        <div className="lg:col-span-7" id="trip-planner">
                            <section aria-label="Trip planner">
