                    ...
                    <div className="max-w-4xl mx-auto bg-black p-16 md:p-24 rounded-3xl text-white relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 justify-center">
                                ...
                                <Button variant="outline" size="lg" asChild className="h-16 md:h-20 px-6 md:px-12 rounded-3xl border-white/20 text-white hover:bg-white/10 text-base md:text-xl font-bold">
