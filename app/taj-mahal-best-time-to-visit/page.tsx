        ...
        <main className="bg-white min-h-screen">
            ...
            <section className="relative pt-44 pb-20 bg-gradient-to-br from-royal-900 via-maroon-700 to-black text-white">
                <div className="container mx-auto px-4 max-w-5xl">
                    <Breadcrumbs items={[{ label: 'Taj Mahal Guide', href: '/taj-mahal-guide' }, { label: 'Best Time to Visit' }]} className="mb-8 text-white/70" />
                    <Badge className="bg-gold-500 text-black border-none mb-6 px-5 py-1.5 uppercase tracking-[0.3em] text-[10px] font-black">Month by Month</Badge>
                    <h1 className="text-5xl md:text-7xl font-display font-bold mb-6 tracking-tighter leading-[0.95]">Best Time to Visit the Taj Mahal</h1>
                    <p className="text-xl md:text-2xl text-white/80 font-light max-w-3xl leading-relaxed">A licensed Agra guide&apos;s honest take on which months work and which to avoid.</p>
                </div>
            </section>
