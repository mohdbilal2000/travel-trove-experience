...
export const tourPlans: TravelPlan[] = [
  {
    ...
    duration: "1 Day",
    price: "Starting from $129 per adult",
  ...
  {
    id: 25,
    title: "Same Day Agra Tour by Flight",
    duration: "1 Day",
    price: "Starting from $299 per adult",
    description: "Premium same-day Agra tour by flight for maximum comfort and time efficiency. Experience the Taj Mahal in luxury with minimal travel time.",
    highlights: [
      "Domestic flight Delhi-Agra-Delhi",
      "Taj Mahal sunrise visit with photography",
      "Agra Fort private guided tour",
      "Fatehpur Sikri UNESCO World Heritage site",
      "Luxury car transfers in Agra",
      "Fine dining lunch at 5-star hotel"
    ],
    inclusions: [
      "Round-trip domestic flight tickets",
      "Private luxury car transfers in Agra",
      "Professional English-speaking guide",
      "All monument entrance fees",
      "Breakfast and fine dining lunch",
    ...
    itinerary: [
      {
        day: 1,
        title: "Delhi to Agra by Flight",
        description: "Early morning 7:00 AM flight from Delhi to Agra. Arrive by 8:00 AM. Private car transfer to Taj Mahal for sunrise visit. Agra Fort guided tour. Fine dining lunch at luxury hotel. Fatehpur Sikri exploration. Local market visit. Evening 6:00 PM flight back to Delhi. Airport transfer to hotel.",
        accommodation: "None",
  ...
  },
  {
    ...
    duration: "1 Day",
    price: "Starting from $149 per adult",
    description: "Authentic Indian railway experience with same-day Agra tour. Travel like locals while visiting the magnificent Taj Mahal and other attractions.",
    highlights: [
      "Fast train journey (train tickets included)",
      "Taj Mahal visit with expert guide",
    ...
    inclusions: [
      "Fast train tickets (AC Chair Car) - included",
      "Private car transfers in Agra",
      "Professional English-speaking guide",
      "All monument entrance fees",
      "Breakfast on train and local lunch",
    ...
    itinerary: [
      {
        day: 1,
        title: "Delhi to Agra by Train",
        description: "Early morning 6:00 AM fast train departure from Delhi. Breakfast served on train. Arrive in Agra by 8:00 AM. Private car transfer to Taj Mahal for guided tour. Agra Fort exploration. Local street food lunch. Fatehpur Sikri visit. Traditional handicraft shopping. Evening 5:50 PM fast train back to Delhi. Arrive by 7:30 PM.",
        accommodation: "None",
        meals: "Breakfast on Train, Local Lunch"
      }
    ]
  },
  {
    ...
    duration: "3 Days",
    price: "Starting from $349 per adult",
  ...
  },
  {
    ...
    duration: "4 Days",
    price: "Starting from $699 per adult",
  ...
  },
  {
    ...
    duration: "5 Days",
    price: "Starting from $1,199 per adult",
  ...
  },
  {
    ...
    duration: "6 Days",
    price: "Starting from $899 per adult",
  ...
  },
  {
    ...
    duration: "7 Days",
    price: "Starting from $999 per adult",
  ...
  },
  {
    ...
    duration: "5 Days",
    price: "Starting from $1,099 per adult",
  ...
  },
  {
    ...
    duration: "4 Days",
    price: "Starting from $199 per adult",
  ...
  },
  {
    ...
    duration: "5 Days",
    price: "Starting from $849 per adult",
  ...
  },
  {
    ...
    duration: "6 Days",
    price: "Starting from $949 per adult",
  ...
  },
  {
    ...
    duration: "5 Days",
    price: "Starting from $799 per adult (discounts for kids under 12)",
  ...
  },
  {
    ...
    duration: "6 Days",
    price: "Starting from $1,049 per adult",
  ...
  },
  {
    ...
    duration: "7 Days",
    price: "Starting from $1,149 per adult",
