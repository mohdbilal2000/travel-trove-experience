...
export const specializedPlans: TravelPlan[] = [
  ...
  },
  {
    ...
    description: "The ultimate luxury experience combining the Golden Triangle with any destination of your choice. Enjoy heritage palace hotels, chauffeur-driven luxury vehicles, and bespoke experiences crafted just for you.",
    highlights: [
      "Exclusive stays in palace hotels and luxury resorts",
      "Concierge-style trip management throughout",
      "Private guided tours with senior licensed guides",
      "Fine-dining reservations at India's top restaurants",
      "Custom spa and wellness treatments",
      "Luxury shopping with trusted specialists",
