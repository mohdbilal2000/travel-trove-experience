...
export const additionalDestinations: TravelPlan[] = [
  {
    id: 7,
...
export const newTourPlans: TravelPlan[] = [
  {
    ...
    description: "A fast-paced itinerary ideal for travelers with limited time, covering essential landmarks efficiently.",
    ...
    itinerary: [
      {
        day: 1,
        title: "Delhi Exploration",
        description: "Quick tour of Delhi's essential landmarks including India Gate, Qutub Minar, and Lotus Temple. Evening transfer to railway station for overnight train to Agra.",
        accommodation: "Overnight train",
        meals: "Breakfast"
      },
      {
        day: 2,
        title: "Agra and Travel to Jaipur",
        description: "Early morning arrival in Agra. Visit Taj Mahal at sunrise and Agra Fort. Afternoon drive to Jaipur.",
      ...
      },
      {
        day: 3,
        title: "Jaipur and Departure",
        description: "Visit Amber Fort and City Palace. Evening departure for onward journey.",
        accommodation: "None",
        meals: "Breakfast"
      }
    ]
  },
  {
    ...
    description: "A balanced tour offering comfort and value with a well-paced exploration of each city.",
    destinations: ["Delhi", "Agra", "Jaipur"],
    highlights: [
    ...
    image: "https://images.unsplash.com/photo-1585135497273-1a86b09fe70e?q=80&w=2070&auto=format&fit=crop",
    rating: 4.7,
    reviews: 124,
    popular: true,
    itinerary: [
      {
        ...
        description: "Full day tour of Delhi including Red Fort, Jama Masjid, Humayun's Tomb, and India Gate.",
      ...
      },
      {
        ...
        description: "Morning visit to Fatehpur Sikri. Continue journey to Jaipur.",
        accommodation: "3-star hotel in Jaipur",
        meals: "Breakfast, Dinner"
      },
      {
        day: 4,
        title: "Jaipur Sightseeing and Departure",
        description: "Visit Amber Fort, City Palace, and Hawa Mahal. Evening departure.",
        accommodation: "None",
        meals: "Breakfast"
      }
    ]
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1607914660217-754fdd90041d?q=80&w=2070&auto=format&fit=crop",
    rating: 4.9,
    reviews: 76,
    popular: false,
    itinerary: [
      {
        day: 1,
        title: "Arrival in Delhi",
        description: "VIP airport welcome. Luxury transfer to hotel. Welcome dinner at specialty restaurant.",
        accommodation: "5-star hotel in Delhi",
        meals: "Welcome Dinner"
      },
      {
        day: 2,
        title: "Delhi Luxury Tour",
        description: "Private guided tour of Red Fort, Qutub Minar, and India Gate with expert historian. Fine dining experience.",
        accommodation: "5-star hotel in Delhi",
        meals: "Breakfast, Lunch, Dinner"
      },
      {
        day: 3,
        title: "Delhi to Agra",
        description: "Chauffeured drive to Agra. Visit Taj Mahal at sunset with private guide. Exclusive rooftop dinner with Taj view.",
      ...
      },
      {
        day: 4,
        title: "Agra to Jaipur",
        description: "Sunrise Taj Mahal visit. Drive to Jaipur with stop at Fatehpur Sikri. Evening cultural entertainment.",
      ...
      },
      {
        ...
        description: "Elephant ride to Amber Fort. Private tour of City Palace including exclusive royal quarters. Visit to Jantar Mantar. Farewell dinner.",
        accommodation: "None",
  ...
  },
  {
    ...
    description: "Deep cultural engagement with hands-on experiences and local interactions.",
    destinations: ["Delhi", "Agra", "Jaipur"],
    highlights: [
    ...
    image: "https://images.unsplash.com/photo-1565073624497-7f8e16ac3efd?q=80&w=2070&auto=format&fit=crop",
    rating: 4.8,
    reviews: 92,
    popular: true,
    itinerary: [
      {
        day: 1,
        title: "Delhi Cultural Introduction",
        description: "Walking tour of Old Delhi. Visit to local markets with guide. Evening cooking class with local family.",
        accommodation: "Mid-range heritage hotel in Delhi",
        meals: "Breakfast, Dinner (prepared during cooking class)"
      },
      {
        day: 2,
        title: "Delhi Cultural Exploration",
        description: "Morning yoga session. Visit to craft museum and artisan workshops. Afternoon cultural performance.",
        accommodation: "Mid-range heritage hotel in Delhi",
        meals: "Breakfast"
      },
      {
        day: 3,
        title: "Delhi to Agra",
        description: "Travel to Agra. Afternoon visit to marble inlay workshop to learn traditional techniques. Evening visit to local community center.",
      ...
      },
      {
        day: 4,
        title: "Agra to Jaipur",
        description: "Morning visit to Taj Mahal. Drive to Jaipur with stop at rural village for traditional lunch and cultural interaction.",
      ...
      },
      {
        ...
        description: "Morning block printing workshop. Visit to pottery village. Afternoon traditional dance class. Evening folk performance with dinner.",
        accommodation: "Heritage haveli in Jaipur",
        meals: "Breakfast, Dinner"
      },
      {
        day: 6,
        title: "Jaipur and Departure",
        description: "Visit to local school or community project. Final shopping for handicrafts with artisan interactions. Evening departure.",
        accommodation: "None",
        meals: "Breakfast"
      }
    ]
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1665492206328-5ae3a8705653?q=80&w=2069&auto=format&fit=crop",
    rating: 4.6,
    reviews: 58,
    popular: false,
    itinerary: [
      {
        day: 1,
        title: "Arrival in Delhi",
        description: "Relaxed arrival and check-in. Brief orientation walk around the hotel area. Evening at leisure.",
        accommodation: "4-star hotel in Delhi",
        meals: "None"
      },
      {
        day: 2,
        title: "Delhi at Leisure",
        description: "Morning visit to Red Fort. Afternoon stroll through Lodhi Gardens. Free time for personal exploration.",
        accommodation: "4-star hotel in Delhi",
        meals: "Breakfast"
      },
      {
        day: 3,
        title: "Delhi Museums and Relaxation",
        description: "Visit to National Museum or choice of galleries. Afternoon and evening at leisure.",
        accommodation: "4-star hotel in Delhi",
        meals: "Breakfast"
      },
      {
        day: 4,
        title: "Delhi to Agra",
        description: "Late morning departure to Agra. Afternoon at leisure to relax at hotel or explore nearby markets.",
        accommodation: "4-star hotel in Agra",
        meals: "Breakfast"
      },
      {
        day: 5,
        title: "Agra Exploration and Travel to Jaipur",
        description: "Morning visit to Taj Mahal and Agra Fort. Leisurely afternoon drive to Jaipur.",
        accommodation: "4-star hotel in Jaipur",
        meals: "Breakfast"
      },
      {
        ...
        description: "Morning visit to Amber Fort. Afternoon visit to City Palace. Evening free for shopping or spa treatments.",
        accommodation: "4-star hotel in Jaipur",
        meals: "Breakfast"
      },
      {
        day: 7,
        title: "Jaipur and Departure",
        description: "Morning at leisure. Optional activities based on interest. Afternoon departure.",
        accommodation: "None",
        meals: "Breakfast"
      }
    ]
  },
  {
    ...
    description: "A thrilling mix of cultural sightseeing and adventure, including a tiger safari in Ranthambore.",
    ...
    image: "https://images.unsplash.com/photo-1585468274952-66591eb14165?q=80&w=2032&auto=format&fit=crop",
    rating: 4.8,
    reviews: 72,
    popular: true,
    itinerary: [
      {
        ...
        description: "Morning cycle tour through Old Delhi, exploring narrow lanes and hidden gems. Afternoon adventure activity in city park. Evening food walk.",
        accommodation: "Adventure-themed hotel in Delhi",
        meals: "Breakfast"
      },
      {
        day: 2,
        title: "Delhi to Agra",
        description: "Drive to Agra. Optional afternoon/evening hiking excursion near Agra.",
        accommodation: "Mid-range hotel in Agra",
        meals: "Breakfast"
      },
      {
        day: 3,
        title: "Agra Adventure and Travel to Ranthambore",
        description: "Early morning hot air balloon ride over Taj Mahal (weather permitting). Visit to Taj Mahal and Agra Fort. Afternoon drive to Ranthambore National Park.",
        accommodation: "Wildlife resort in Ranthambore",
        meals: "Breakfast, Dinner"
      },
      {
        day: 4,
        title: "Ranthambore and Travel to Jaipur",
        description: "Early morning and afternoon tiger safaris in Ranthambore National Park. Evening drive to Jaipur.",
        accommodation: "Mid-range hotel in Jaipur",
        meals: "Breakfast, Lunch"
      },
      {
        day: 5,
        title: "Jaipur Adventure and Departure",
        description: "Elephant ride at Amber Fort. Optional zip-lining activity at nearby adventure park. Evening departure.",
        accommodation: "None",
        meals: "Breakfast"
      }
    ]
...
// Combine all plans
export const allPlans = [...travelPlans, ...additionalDestinations, ...newTourPlans];
