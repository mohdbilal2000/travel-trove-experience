...
const ItineraryMap = ({ plan }: ItineraryMapProps) => {
  ...
  const mapImages = [
    "/images/delhi/getty-images-C4Yf3Wbymg8-unsplash.jpg", // Delhi
    "/images/agra/getty-images-ge82SKhuwCA-unsplash.jpg", // Agra
    "/images/jaipur/getty-images-zlqHXvaEIiI-unsplash.jpg", // Jaipur
    "/images/delhi/ashim-d-silva-KF7pv-8OiyY-unsplash.jpg", // Nature/Wildlife
    "/images/agra/getty-images-Mfck6jSVcbY-unsplash.jpg", // Colorful flowers
    "/images/jaipur/ved-SRAUI9X4Ep8-unsplash.jpg", // Mountain landscape
    "/images/delhi/sagar-dwivedi-iR9xWm1JK20-unsplash.jpg", // Pine trees
    "/images/agra/pankaj-singh-3okI5js2yIc-unsplash.jpg", // Water body
    "/images/jaipur/getty-images-b5yYo61ALvk-unsplash.jpg", // Camels
  ];
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-ivory-200">
              ...
              <div className="relative h-48 bg-gradient-to-r from-maroon-900 to-royal-800">
                <OptimizedImage 
                  src="/images/agra/george-dagerotip-KhZzezzcAzU-unsplash.jpg"
                  alt="Luxury Experience"
                  className="w-full h-full object-cover-optimized mix-blend-overlay"
                  priority={false}
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-royal-700">
                        {plan.itinerary[0].accommodation}
                        {/4[- ]?star|5[- ]?star/i.test(plan.itinerary[0].accommodation) && (
                          <span className="text-maroon-600 font-medium"> (Buffet breakfast included)</span>
                        )}
                      </p>
                    </div>
                  </div>
  ...
  const getBackgroundImage = (index: number) => {
    return mapImages[index % mapImages.length];
  };
                          ...
                          <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-maroon-50 to-royal-50 rounded-xl">
                            ...
                            <div>
                              ...
                              <p className="text-royal-700 text-sm">
                                {day.accommodation}
                                {/4[- ]?star|5[- ]?star/i.test(day.accommodation) && (
                                  <span className="text-maroon-600 font-medium"> (Buffet breakfast included)</span>
                                )}
                              </p>
                            </div>
