...
const services = [
  {
    ...
    description: "Male and female guides available to provide cultural and historical insights based on your preference. Multi-language guides are available to ensure you feel comfortable and understood throughout your journey.",
    icon: Users,
    link: "/guide-booking"
  },
  {
